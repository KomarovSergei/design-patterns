...
class Specification {
  constructor() {
    if (this.constructor.name === "Specification") throw new Error("Specification is abstract!");
  }
...
for (let p of pf.filterByColor(products, Color.green)) log(` * ${p.name} is green`);
